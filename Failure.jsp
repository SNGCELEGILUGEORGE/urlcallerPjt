                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Failure Reports</h5>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <% 
                                         ...
                                         String q1="select insdate ,count(insdata) as failure from tbl_insresponse where status=0 group by insdate";
                                         ResultSet rs=obj.select(q1);
                                          
                                            while(rs.next())
                                            {
                                                     String data=rs.getString("insdate");
                                                     String failurecount=rs.getString("failure");
